...
\begin{verbatim}
([#object[java.time.LocalDate 0x31715e29 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x6a75cfe0 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x32d4287b "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x1d158ebc "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@3049b1fe}{\nolinkurl{java.lang.Object@3049b1fe}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5000 & A\tabularnewline
2 & 2 & 1.000 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@241e9555}{\nolinkurl{java.lang.Object@241e9555}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5000 & A\tabularnewline
1 & 3 & 1.500 & C\tabularnewline
...
\midrule
\endhead
0.1151 & 1 & 0.5000 & A\tabularnewline
0.7605 & 2 & 1.000 & B\tabularnewline
0.02764 & 3 & 1.500 & C\tabularnewline
0.06691 & 4 & 0.5000 & A\tabularnewline
0.8581 & 5 & 1.000 & B\tabularnewline
0.6666 & 6 & 1.500 & C\tabularnewline
0.9442 & 7 & 0.5000 & A\tabularnewline
0.4027 & 8 & 1.000 & B\tabularnewline
0.8871 & 9 & 1.500 & C\tabularnewline
\bottomrule
\end{longtable}
...
\begin{verbatim}
#object["[J" 0x2d1f3596 "[J@2d1f3596"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x23e21d06 "[J@23e21d06"] #object["[J" 0x40b79a85 "[J@40b79a85"] #object["[J" 0xf38c6c7 "[J@f38c6c7"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x5c8c0d2f "[Ljava.lang.String;@5c8c0d2f"]
#object["[F" 0x4788c116 "[F@4788c116"]
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/head relig-income)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{     (}\KeywordTok{take} \DecValTok{11}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(api/pivot->longer bilboard #(clojure.string/starts-with? }\VariableTok{%} \StringTok{"wk"}\NormalTok{) \{}\AttributeTok{:target-cols} \AttributeTok{:week}
