...
\begin{verbatim}
([#object[java.time.LocalDate 0x372229e5 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x8f50918 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x4381a50f "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x447ce3c4 "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@69194e2b}{\nolinkurl{java.lang.Object@69194e2b}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5000 & A\tabularnewline
2 & 2 & 1.000 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@2e224912}{\nolinkurl{java.lang.Object@2e224912}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5000 & A\tabularnewline
1 & 3 & 1.500 & C\tabularnewline
...
\midrule
\endhead
0.6420 & 1 & 0.5000 & A\tabularnewline
0.1798 & 2 & 1.000 & B\tabularnewline
0.6046 & 3 & 1.500 & C\tabularnewline
0.9266 & 4 & 0.5000 & A\tabularnewline
0.1213 & 5 & 1.000 & B\tabularnewline
0.3460 & 6 & 1.500 & C\tabularnewline
0.2824 & 7 & 0.5000 & A\tabularnewline
0.8035 & 8 & 1.000 & B\tabularnewline
0.08914 & 9 & 1.500 & C\tabularnewline
\bottomrule
\end{longtable}
...
\begin{verbatim}
#object["[J" 0x53acfcc2 "[J@53acfcc2"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x9e81183 "[J@9e81183"] #object["[J" 0x452d614 "[J@452d614"] #object["[J" 0x14a5682b "[J@14a5682b"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x25fb5e87 "[Ljava.lang.String;@25fb5e87"]
#object["[F" 0x3effb761 "[F@3effb761"]
\end{verbatim}
...
\midrule
\endhead
1 & 1 & 0 & 0.2284 & 0.7376 & 3 & -2\tabularnewline
2 & 1 & 1 & 0.4162 & 0.7503 & 3 & -2\tabularnewline
3 & 0 & 1 & 0.1670 & 0.1311 & 3 & -2\tabularnewline
4 & 0 & 1 & 0.5422 & 0.4144 & 3 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & 1 & 0 & 1 & 0.2284 & 3\tabularnewline
2 & 1 & 1 & 1 & 0.4162 & 3\tabularnewline
3 & 0 & 1 & 1 & 0.1670 & 3\tabularnewline
4 & 0 & 1 & 1 & 0.5422 & 3\tabularnewline
1 & 1 & 0 & 2 & 0.7376 & -2\tabularnewline
2 & 1 & 1 & 2 & 0.7503 & -2\tabularnewline
3 & 0 & 1 & 2 & 0.1311 & -2\tabularnewline
4 & 0 & 1 & 2 & 0.4144 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\NormalTok{    (api/select-rows #(}\KeywordTok{=} \StringTok{"AA"}\NormalTok{ (}\KeywordTok{get} \VariableTok{%} \StringTok{"carrier"}\NormalTok{))) }\CommentTok{;; filter rows by carrier="AA"}
\NormalTok{    (api/group-by [}\StringTok{"origin"} \StringTok{"dest"} \StringTok{"month"}\NormalTok{]) }\CommentTok{;; group by several columns}
\NormalTok{    (api/aggregate \{}\AttributeTok{:arr-delay-mean}\NormalTok{ #(tech.v2.datatype.functional/mean (}\VariableTok{%} \StringTok{"arr_delay"}\NormalTok{)) }\CommentTok{;; calculate mean of arr_delay...}
...
\paragraph{Shape of loaded data}\label{shape-of-loaded-data}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\BuiltInTok{def}\FunctionTok{ DT }\NormalTok{(api/dataset \{}\AttributeTok{:ID}\NormalTok{ [}\StringTok{"b"} \StringTok{"b"} \StringTok{"b"} \StringTok{"c"} \StringTok{"c"} \StringTok{"a"}\NormalTok{]}
...
b & 2 & 8 & 14\tabularnewline
b & 3 & 9 & 15\tabularnewline
c & 4 & 10 & 16\tabularnewline
c & 5 & 11 & 17\tabularnewline
a & 6 & 12 & 18\tabularnewline
\bottomrule
\end{longtable}
...
\paragraph{Subset rows}\label{subset-rows}
...
\paragraph{Select column(s)}\label{select-columns}
...
\paragraph{Compute or do}\label{compute-or-do}
...
\paragraph{Subset and do}\label{subset-and-do}
...
\paragraph{Columns by names}\label{columns-by-names}

Most of the R code is skipped since it doesn't bring anything API
specific.
...
\paragraph{Grouping}\label{grouping-1}
...
\begin{longtable}[]{@{}lllll@{}}
\toprule
month & origin & dest & :m\_arr & :m\_dep\tabularnewline
\midrule
\endhead
...
\paragraph{Sorted by}\label{sorted-by}
