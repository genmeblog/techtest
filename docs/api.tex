...
\begin{verbatim}
([#object[java.time.LocalDate 0x75bf3698 "2012-01-01"] 0.0 12.8 5.0 4.7 "drizzle"] [#object[java.time.LocalDate 0x60ad4ff5 "2012-01-02"] 10.9 10.6 2.8 4.5 "rain"])
\end{verbatim}
...
\begin{verbatim}
({"date" #object[java.time.LocalDate 0x422b3c72 "2012-01-01"],
  "precipitation" 0.0,
  "temp_min" 5.0,
  "weather" "drizzle",
  "temp_max" 12.8,
  "wind" 4.7}
 {"date" #object[java.time.LocalDate 0x775fd53c "2012-01-02"],
  "precipitation" 10.9,
  "temp_min" 2.8,
  "weather" "rain",
  "temp_max" 10.6,
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@ca3faad}{\nolinkurl{java.lang.Object@ca3faad}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5000 & A\tabularnewline
2 & 2 & 1.000 & B\tabularnewline
...
\toprule
v1 & v2 & {[}1 2 3{]} &
\href{mailto:java.lang.Object@7d37d30}{\nolinkurl{java.lang.Object@7d37d30}}\tabularnewline
\midrule
\endhead
1 & 1 & 0.5000 & A\tabularnewline
1 & 3 & 1.500 & C\tabularnewline
...
\midrule
\endhead
0.4212 & 1 & 0.5000 & A\tabularnewline
0.01862 & 2 & 1.000 & B\tabularnewline
0.4185 & 3 & 1.500 & C\tabularnewline
0.4456 & 4 & 0.5000 & A\tabularnewline
0.7543 & 5 & 1.000 & B\tabularnewline
0.7168 & 6 & 1.500 & C\tabularnewline
0.1660 & 7 & 0.5000 & A\tabularnewline
0.7774 & 8 & 1.000 & B\tabularnewline
0.3410 & 9 & 1.500 & C\tabularnewline
\bottomrule
\end{longtable}
...
\begin{verbatim}
#object["[J" 0x75bbeec8 "[J@75bbeec8"]
\end{verbatim}
...
\begin{verbatim}
(#object["[J" 0x3535a0ed "[J@3535a0ed"] #object["[J" 0xcf55b3b "[J@cf55b3b"] #object["[J" 0xc35edea "[J@c35edea"])
\end{verbatim}
...
\begin{verbatim}
#object["[Ljava.lang.String;" 0x3696da42 "[Ljava.lang.String;@3696da42"]
#object["[F" 0x2d9291be "[F@2d9291be"]
\end{verbatim}
...
\midrule
\endhead
1 & 1 & 0 & 0.6760 & 0.1799 & 3 & -2\tabularnewline
2 & 1 & 1 & 0.3435 & 0.6426 & 3 & -2\tabularnewline
3 & 0 & 1 & 0.4568 & 0.8009 & 3 & -2\tabularnewline
4 & 0 & 1 & 0.9421 & 0.9790 & 3 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & 1 & 0 & 1 & 0.6760 & 3\tabularnewline
2 & 1 & 1 & 1 & 0.3435 & 3\tabularnewline
3 & 0 & 1 & 1 & 0.4568 & 3\tabularnewline
4 & 0 & 1 & 1 & 0.9421 & 3\tabularnewline
1 & 1 & 0 & 2 & 0.1799 & -2\tabularnewline
2 & 1 & 1 & 2 & 0.6426 & -2\tabularnewline
3 & 0 & 1 & 2 & 0.8009 & -2\tabularnewline
4 & 0 & 1 & 2 & 0.9790 & -2\tabularnewline
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}llllll@{}}
\toprule
GEOID & NAME & {[}{[}``rent''{]} ``estimate''{]} & {[}{[}``rent''{]}
``moe''{]} & {[}{[}``income''{]} ``estimate''{]} & {[}{[}``income''{]}
``moe''{]}\tabularnewline
\midrule
\endhead
1 & Alabama & 747 & 3 & 24476 & 136\tabularnewline
